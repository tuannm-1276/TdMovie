...
import 'bubble_bottom_navigation_bar_item.dart';

const double _kActiveFontSize = 14.0;
const double _kBottomMargin = 8.0;
enum BubbleBottomNavigationBarFabLocation { end, center }

// ignore: must_be_immutable
class BubbleBottomNavigationBar extends StatefulWidget {
  BubbleBottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
    ...
    this.cornerRadius = 48,
        ...
        assert(
          items.every(
                  (BubbleBottomNavigationBarItem item) => item.title != null) ==
              true,
  ...
  final List<BubbleBottomNavigationBarItem> items;
  ...
  final bool hasNotch;
  final bool hasInk;
  final BubbleBottomNavigationBarFabLocation fabLocation;
...
class _BottomNavigationBarState extends State<BubbleBottomNavigationBar>
  ...
  @override
  void didUpdateWidget(BubbleBottomNavigationBar oldWidget) {
    ...
    if (widget.currentIndex != oldWidget.currentIndex) {
      ...
      if (widget.fabLocation == BubbleBottomNavigationBarFabLocation.center) {
        BubbleBottomNavigationBarItem _currentItem =
            widget.items[oldWidget.currentIndex];
        BubbleBottomNavigationBarItem _nextItem =
        ...
        child: Material(
          ...
          child: Padding(
            padding: EdgeInsets.only(
                ...
                right: widget.fabLocation ==
                        BubbleBottomNavigationBarFabLocation.end
                    ? 72
                    : 0),
    ...
    return Semantics(
      ...
      child: widget.hasNotch
          ? PhysicalShape(
              ...
              clipper: _BubbleBottomNavigationBarClipper(
...
class _BubbleBottomNavigationBarClipper extends CustomClipper<Path> {
  const _BubbleBottomNavigationBarClipper({
  ...
  @override
  bool shouldReclip(_BubbleBottomNavigationBarClipper oldClipper) {
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final BubbleBottomNavigationBarItem item;
